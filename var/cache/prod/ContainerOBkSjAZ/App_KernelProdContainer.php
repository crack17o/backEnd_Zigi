...
class App_KernelProdContainer extends Container
{
    ...
    protected static function getSecurity_FirewallService($container)
    {
        ...
        return $container->privates['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
